...
type FeaturesRequestReactor interface {
    FeaturesRequest(features *common.Header)
}
...
type GetConfigRequestReactor interface {
    GetConfigRequest(config *common.Header)
}
...
type BarrierRequestReactor interface {
    BarrierRequest(req *common.Header)
}

type BarrierReplyReactor interface {
    BarrierReply(dpid net.HardwareAddr, msg *common.Header)
}
