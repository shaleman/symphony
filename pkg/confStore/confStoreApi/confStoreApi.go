...
// Plugin API
type ConfStorePlugin interface {
...
var pluginList map[string]ConfStorePlugin = make(map[string]ConfStorePlugin)

// Register a plugin
func RegisterPlugin(name string, plugin ConfStorePlugin) error {
